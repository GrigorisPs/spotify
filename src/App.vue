  ...
  <div>
      ...
      class="bg-black hover:bg-[#282828] rounded-full p-0.5 mr-8 mt-0.5 cursor-pointer">
        <div class="flex items-center">
          ...
          class="rounded-full"
          width="27"
          src="https://yt3.ggpht.com/yti/ANjgQV-3oaKXbGMCyhwBALclya3n2XHGcY9J60PUwlzWRA=s88-c-k-c0x00ffffff-no-rj"
          />
          <div class="text-white text-[14px] ml-1.5 font-semibold">Greg Palaio</div>
      ...
      <ul class="text-gray-200 font-semibold text-[14px]">
        <li class="px-3 py-2 hover:bg-[#3E3D3D] border-b border-b-gray-600">Profile</li>
        <li class="px-3 py-2 hover:bg-[#3E3D3D] border-b border-b-gray-600">Settings</li>
        <li class="px-3 py-2 hover:bg-[#3E3D3D] border-b border-b-gray-600">Log out</li>
      </ul>
      </span>
      </div>
